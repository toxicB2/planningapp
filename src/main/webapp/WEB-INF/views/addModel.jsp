...
$(document).ready(function(){
    function one2two()
    {
	    $("select[name='Credentials ID']").change(function()
        {
            $("select[name='Roles ID']").val($(this).val());
        });
    }
    
    function two2one()
    {
	    $("select[name='Roles ID']").change(function()
        {
            $("select[name='Credentials ID']").val($(this).val());
        });
    }
    one2two();
    two2one();
